package com.ValdaLauraUswary_F55121074.firestore074;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSaveBtn.setOnClickListener(v -> {
            ...
            if (!username.equals("") && !stambuk.equals("")) {
                mFirestore.collection("pengguna").add(userMap).addOnSuccessListener(documentReference -> {
                    Toast.makeText(this, "Pengguna Ditambahkan di Firestore", Toast.LENGTH_SHORT).show();
        ...
        mListText.setOnClickListener(v -> {
            Intent regosterIntent = new Intent(MainActivity.this, ListActivity.class);
            startActivity(regosterIntent);
